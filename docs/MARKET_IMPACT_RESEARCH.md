...
“I aligned each signal only with later market outcomes and used processed timestamps to prevent
future articles entering a window. I held out the latest observations chronologically and compared
sentiment direction with market persistence. The sample is too small for inference, so the system
suppresses p-values and clearly labels correlations as descriptive.”
