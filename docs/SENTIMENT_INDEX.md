...
“I designed the index so direction, confidence and evidence coverage are not conflated. Duplicate
stories and repeated sources share weight, and every aggregate links to article contributions.
I also publish sensitivity scenarios because index weights are assumptions. The synthetic output
proves reproducibility—not predictive value.”
